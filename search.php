...
if(!isset($_SESSION['login'])){ //if login in session is not set
    header("Location: https://latinlocator.com/login.php");
}
$line = date('Y-m-d H:i:s') . " - $_SERVER[REMOTE_ADDR] - " . $_SESSION['login'];
//$line = $sline ;
file_put_contents('test.txt', $line . PHP_EOL, FILE_APPEND);
...
<div class="grid-container">
  ...
  <div id="Logo" style="background-image: url('NewestLogoBordor.png'); background-size: contain; background-repeat: no-repeat; background-position: center; width: 8fr:"></div>
  <div id="Button1">
  </div>
  <div id="SearchBar" style="display: flex; justify-content: center; align-items: center;">
  ...
  <div id="Results" style="font-size: 120%; padding: 6px; outline-offset: -1px; overflow-y:auto; overflow-x: none;">
    <div id ="author">
    </div>
    <div id ="title">
    </div>
  ...
  <div id="Indexes" style="display: flex; align-items: center; justify-content: center; overflow-y:auto; overflow-x: none;">
  ...
  <div id="ParsingBox" style=" margin-top: 10%; padding: 6px; outline-offset: -1px; overflow-y:auto; overflow-x: none;">
    <div id="other" style="overflow-y:auto; overflow-x: none;"> </div>
  </div>
  <div id="NounBox" style="display: flex; justify-content: center; align-items: center; margin-top: 10%; padding: 6px; outline-offset: -1px; margin-right: 5%; overflow-y:auto; overflow-x: none;">
    <div id="nounDef" style="width: auto; height: auto; font-size: 180%; overflow-y:auto; overflow-x: none;"> </div>
  </div>
  <div id="LatinBox" style="text-align: left;  width: 100%; height: 100%; margin: auto; display: flex; align-items: center;">
    <div id="inLatin" style="width: 80%; line-height: 1.5; padding-left: 5%; font-size: 120%; height: 80%; padding: 6px; outline-offset: -1px; overflow-y:auto; overflow-x: none; margin-left: auto;">
    </div>
  </div>
  <div id="EnglishBox" style="text-align: left; display: flex; align-items: center; justify-content: left; ">
    <div id="inEnglish" style="width: 80%; line-height: 1.5; padding-left: 5%; font-size: 120%; height: 80%;; padding: 6px; outline-offset: -1px; overflow-y:auto; overflow-x: none;">
    </div>
  </div>
  <div id="SumBox">
    <div id="sumDiv" style="text-align: left; overflow-y:scroll; height: auto; padding: 0; margin-left: 10%; padding: 6px; outline-offset: -1px; overflow-y:auto; overflow-x: none;">
    </div>
  </div>
  <div id="ComBox" style="">
      <div id="inCom" style="text-align: left; height: 100%; padding: 0; margin-right: 10%; padding: 6px; outline-offset: -1px; overflow-y:auto; overflow-x: none;">
      </div>
  </div>
</div>
